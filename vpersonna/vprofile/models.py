...
class Client(models.Model):
    ...
    email_regex = RegexValidator(regex="[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?$", message='Wrong email format!')
    ...
    uname_regex = RegexValidator(regex='^[a-z0-9_\.]{3,25}$', message="Username contains just digits, letters . and  _")
